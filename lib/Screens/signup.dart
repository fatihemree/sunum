                        ...
                        FadeAnimation(1, Container(
                          ...
                          child: Stack(
                            children: <Widget>[
                              Positioned(
                                child: Container(
                                child: Center(child: Text("Kayıt ol", style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.bold)),)
                                )
                              )
                            ]
                          ),
                            ...
                            child:  Column(
                              children: <Widget> [
                                Container(
                                    height: screenData.size.height / 1.7 ,
                               ...
                               GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text("Kayıt", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold))                            
                                  ),
                                )),
                                Container(
                                   margin: EdgeInsets.only(top: 10),
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Text("Hesabınız var mı?", style: TextStyle(color: Colors.lightBlueAccent, fontWeight: FontWeight.bold))
                                  )
                                )
                              ]
                            ),
